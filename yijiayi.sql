...
CREATE TABLE `yiyi_ad` (
  ...
  `type` int(3) DEFAULT '0' COMMENT '广告类型',
  `siteid` int(10) DEFAULT NULL,
  `colunmid` int(10) DEFAULT NULL,
  `title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pic` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `switch` enum('false','true','del','delete') CHARACTER SET utf8 NOT NULL DEFAULT 'true' COMMENT '状态（0：禁用   1：启用   2：删除  3：彻底删除-回收站不可见）',
  `orderid` int(10) NOT NULL COMMENT '排列排序',
  `addtime` int(10) DEFAULT NULL COMMENT '公司状态，1省公司，2市公司，3分理处',
  `addadmin` int(10) unsigned NOT NULL,
  `uptime` int(10) NOT NULL,
  `upadmin` smallint(5) NOT NULL,
...
CREATE TABLE `yiyi_admin` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(30) COLLATE utf8_unicode_ci NOT NULL COMMENT '管理员名称',
  `password` char(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '管理员密码',
  `salts` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '加密字符',
  `gonghao` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0' COMMENT '员工编号',
  `is_gonghao` int(2) NOT NULL DEFAULT '0' COMMENT '是否设置员工编号 0:未设置 1已设置',
  `cityarr` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '所在城市组合地址',
  `city` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '所在地区',
  `zhiwu` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `IDcard` char(25) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '身份证',
  `tel` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '座机电话',
  `mobile` char(11) COLLATE utf8_unicode_ci NOT NULL COMMENT '手机号',
  `email` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备用邮箱',
  `email2` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备用邮箱',
  `qq` char(15) COLLATE utf8_unicode_ci NOT NULL COMMENT 'QQ号',
  `admingroup` int(11) NOT NULL DEFAULT '0' COMMENT '权限组',
  `logintime` int(10) NOT NULL COMMENT '登录时间',
  `loginip` char(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '登录IP地址',
  `last_logintime` int(10) NOT NULL COMMENT '上一次登录时间',
  `last_loginip` char(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '上一次登录IP地址',
  `ziliao_fujian` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '附件',
  `address` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '地址',
  `sex` enum('n','y') COLLATE utf8_unicode_ci DEFAULT 'n' COMMENT '女 男',
  `site` tinyint(1) NOT NULL DEFAULT '0' COMMENT '站点',
  `switch` enum('false','true','del','delete') CHARACTER SET utf8 NOT NULL DEFAULT 'true' COMMENT '状态（0：禁用   1：启用   2：删除  3：彻底删除-回收站不可见）',
  `orderid` int(10) NOT NULL COMMENT '排列排序',
  `addtime` int(10) DEFAULT NULL COMMENT '公司状态，1省公司，2市公司，3分理处',
  `addadmin` int(10) unsigned NOT NULL,
  ...
  `deladmin` smallint(5) unsigned NOT NULL,
  `sys` enum('true','false') CHARACTER SET utf8 NOT NULL DEFAULT 'false',
  `culture` int(2) NOT NULL DEFAULT '0',
  `bank` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `bankCard` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `beizhu` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `facepic` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '头像',
  PRIMARY KEY (`id`)
...
CREATE TABLE `yiyi_admin_group` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '管理组id',
  `level` int(5) NOT NULL DEFAULT '0',
  `title` varchar(30) NOT NULL COMMENT '管理组名称',
  `des` text NOT NULL COMMENT '管理组描述',
  `limits` text NOT NULL COMMENT '权限数组',
  `siteid` int(10) NOT NULL DEFAULT '1' COMMENT '站点',
  `switch` enum('false','true','del','delete') NOT NULL DEFAULT 'false' COMMENT '状态（0：禁用   1：启用   2：删除  3：彻底删除-回收站不可见）',
  `addtime` int(10) NOT NULL,
  `addadmin` smallint(10) unsigned NOT NULL,
  `uptime` int(10) NOT NULL,
  `upadmin` smallint(10) unsigned NOT NULL,
  `deltime` int(10) NOT NULL,
  `deladmin` smallint(10) unsigned NOT NULL,
  `orderid` smallint(5) unsigned NOT NULL COMMENT '排列排序',
  `sys` enum('false','true') NOT NULL DEFAULT 'false' COMMENT 'true 表示只有开发组使用',
  PRIMARY KEY (`id`)
...
CREATE TABLE `yiyi_admin_menu` (
  ...
  `ptr` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0,',
  `title_cn` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT '标题',
  `m` char(50) CHARACTER SET utf8 NOT NULL,
  `c` char(50) CHARACTER SET utf8 NOT NULL,
  `a` char(50) CHARACTER SET utf8 NOT NULL,
  `t` char(50) CHARACTER SET utf8 NOT NULL,
  `mtr` char(50) CHARACTER SET utf8 NOT NULL,
  `filepath` varchar(50) CHARACTER SET utf8 NOT NULL,
  `islink` enum('0','1') CHARACTER SET utf8 NOT NULL DEFAULT '1',
  `motion` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '备注：all - 可以查看，也不需要对任何操作做权限判断',
  `method` varchar(50) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `switch` enum('true','false') CHARACTER SET utf8 NOT NULL DEFAULT 'true' COMMENT 'open,close,del',
  `display` enum('true','false') CHARACTER SET utf8 NOT NULL DEFAULT 'false' COMMENT '是否隐藏菜单',
  `orderid` smallint(3) NOT NULL DEFAULT '0',
  `site` int(10) NOT NULL DEFAULT '1' COMMENT '站点 1 后台信息管理系统  2、业务管理系统 3、数据管理系统',
  `sys` enum('false','true') CHARACTER SET utf8 NOT NULL DEFAULT 'false' COMMENT 'true 表示只有开发组使用',
  PRIMARY KEY (`id`)
...
CREATE TABLE `yiyi_area` (
  ...
  `switch` enum('false','true','del','delete') NOT NULL DEFAULT 'true' COMMENT '状态（0：禁用   1：启用   2：删除  3：彻底删除-回收站不可见）',
  `orderid` int(10) NOT NULL COMMENT '排列排序',
  `addtime` int(10) DEFAULT NULL COMMENT '公司状态，1省公司，2市公司，3分理处',
  `addadmin` int(10) unsigned NOT NULL,
  `uptime` int(10) NOT NULL,
  ...
  `deltime` int(10) unsigned NOT NULL,
  `deladmin` smallint(5) unsigned NOT NULL,
  `sys` enum('true','false') NOT NULL DEFAULT 'false',
  PRIMARY KEY (`id`)
...
CREATE TABLE `yiyi_column` (
  ...
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT '站点id',
  `attr` varchar(5) NOT NULL COMMENT '属性: 1：单页  2：列表 3:图文',
  `pid` smallint(5) unsigned NOT NULL COMMENT '栏目上级id',
  `title` varchar(30) NOT NULL COMMENT '栏目名称',
  `content` text NOT NULL COMMENT '内容',
  `url` varchar(255) NOT NULL COMMENT '跳转链接',
  `pic` varchar(100) NOT NULL COMMENT '缩略图片',
  `pic_arr` varchar(255) DEFAULT NULL,
  `seotitle` varchar(80) NOT NULL COMMENT 'SEO标题',
  `keywords` varchar(50) NOT NULL COMMENT '关键词',
  `description` varchar(255) NOT NULL COMMENT '描述',
  `orderid` smallint(5) unsigned NOT NULL COMMENT '排列排序',
  `show_weizhi` varchar(255) DEFAULT '1' COMMENT '显示位置 1:顶部2：左侧3：底部',
  `switch` enum('false','true','del','delete') NOT NULL DEFAULT 'true',
  `addtime` int(10) NOT NULL,
  `addadmin` int(10) unsigned NOT NULL,
  `uptime` int(10) NOT NULL,
  `upadmin` int(10) unsigned NOT NULL,
...
CREATE TABLE `yiyi_column_list` (
  ...
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT '站点id',
  `column_id` tinyint(2) unsigned NOT NULL COMMENT '栏目 类型 ID',
  `title` varchar(80) NOT NULL COMMENT '标题',
  `flag` varchar(20) DEFAULT NULL COMMENT '属性: 1:置顶 2：特荐 3：推荐',
  ...
  `is_status` varchar(8) NOT NULL DEFAULT '1' COMMENT '是否发布：0：不发布 1：发布',
...
CREATE TABLE `yiyi_config` (
  ...
  `vardes` varchar(200) NOT NULL COMMENT '说明',
  `varinfo` varchar(100) NOT NULL COMMENT '参数说明',
  `vargroup` smallint(5) unsigned NOT NULL COMMENT '所属组',
  `vartype` char(10) NOT NULL COMMENT '变量类型',
  `varvalue` text NOT NULL COMMENT '变量值',
  `orderid` smallint(5) unsigned NOT NULL COMMENT '排列排序',
  `switch` enum('true','false','del','delete') NOT NULL DEFAULT 'true' COMMENT '系统默认  当为true时不能被开发组以外的组删除',
  `sys` enum('false','true') NOT NULL DEFAULT 'false' COMMENT 'true 表示只有开发组使用',
  PRIMARY KEY (`id`)
...
CREATE TABLE `yiyi_link` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `type` int(2) DEFAULT '0' COMMENT '类型： 1 文字 2 图片',
  `title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pic` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `switch` enum('false','true','del','delete') CHARACTER SET utf8 NOT NULL DEFAULT 'true' COMMENT '状态（0：禁用   1：启用   2：删除  3：彻底删除-回收站不可见）',
...
CREATE TABLE `yiyi_member` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上级管理员id',
  `ptr` varchar(80) CHARACTER SET utf8 NOT NULL COMMENT '上级管理员id 数组',
  `branchid` tinyint(3) NOT NULL DEFAULT '0' COMMENT '归属分公司',
  ...
  `regip` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT '注册IP',
  `logintime` int(10) unsigned NOT NULL COMMENT '登陆时间',
  `loginip` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT '登陆IP',
  `portrait` varchar(30) CHARACTER SET utf8 NOT NULL,
  `switch` enum('true','false','del','delete') CHARACTER SET utf8 NOT NULL DEFAULT 'false',
  `addtime` int(11) NOT NULL,
  `addadmin` smallint(3) unsigned NOT NULL,
  `uptime` int(11) NOT NULL,
  `upadmin` smallint(3) unsigned NOT NULL,
  `deltime` int(11) NOT NULL,
  `deladmin` smallint(3) unsigned NOT NULL,
  `system` enum('1','0') CHARACTER SET utf8 NOT NULL DEFAULT '0' COMMENT '系统默认，1为不能删除',
  `is_lock` enum('true','false') CHARACTER SET utf8 NOT NULL DEFAULT 'false' COMMENT '账户锁定，不能进行交易',
  `sys` enum('true','false') CHARACTER SET utf8 NOT NULL DEFAULT 'false',
  PRIMARY KEY (`id`)
...
CREATE TABLE `yiyi_message` (
  ...
  `pid` int(10) DEFAULT '0' COMMENT '回复对象id',
  `ismember` enum('true','false') DEFAULT 'false' COMMENT '是否是会员留言',
  `mid` int(10) DEFAULT '0' COMMENT '会员ID',
  `cnname` varchar(20) DEFAULT '' COMMENT '昵称',
  `nickname` varchar(20) DEFAULT '' COMMENT '昵称',
  `mobile` varchar(255) DEFAULT '0' COMMENT '手机号',
  `tel` varchar(255) DEFAULT '0' COMMENT '手机号',
  `content` varchar(255) DEFAULT '' COMMENT '留言内容',
  `a` varchar(255) DEFAULT NULL COMMENT '对应操作模块',
  `tbname` varchar(255) DEFAULT NULL COMMENT '对应操作模块',
  `tbnameid` varchar(25) DEFAULT NULL COMMENT '操作对象ID',
  `type` enum('1','2','3','4') DEFAULT NULL COMMENT '留言类型: 1、留言 2、投稿 3、评论 4、私教报名留言',
  `is_status` enum('true','false','load') DEFAULT 'load',
  `checktime` int(20) DEFAULT NULL COMMENT '审核时间',
  `checkadmin` int(10) DEFAULT '0' COMMENT '审核管理员ID号',
  ...
  `deladmin` smallint(10) unsigned NOT NULL,
  `sys` enum('true','false') NOT NULL DEFAULT 'false',
  `title` varchar(50) DEFAULT NULL COMMENT '标题 (属投稿)',
  `typeid` int(10) DEFAULT '0' COMMENT '投稿类型',
  `site` int(255) DEFAULT '1' COMMENT '站点',
  PRIMARY KEY (`id`)
