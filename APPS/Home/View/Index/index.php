     ...
     <div class="index main-content">
                    ...
                    <ul class="exampleList clear">
                        <li class="clear">
                            <a href="student_record.html">
                                <img class="border50 fl" src="Images/touxiang.jpg" alt="">
                ...
                <div class="champion_slide">
                    <ul class="championList swiper-wrapper clear">
                        <li class="swiper-slide">
                            <a href="student_record.html">
                                <div class="img-info">
                                    <img class="border50" src="Images/touxiang.jpg" alt="">
                                </div>
                                <div class="text-info">
        ...
        <div class="teachModel content_item">
            <div class="content_item_bg">
                ...
                <div>
                    <img src="Images/moshi1.png" width="100%" alt="">
                </div>
                <div class="title font60">
                ...
                <div>
                    <img src="Images/moshi2.png" width="100%" alt="">
                </div>
            </div>
        </div>
        <!--20+模式-->
                ...
                <div class="custom_content">
                    ...
                    <div class="custom_detail">
                        <div class="custom_detail_item">
                            <div>
                                <img src="Images/custom01.jpg" width="100%" alt="">
                                <p class="text-center">
                                    定向师资
                                </p>
                            </div>
                        ...
                        <div class="custom_detail_item">
                            <div>
                                <img src="Images/custom02.jpg" width="100%" alt="">
                                <p class="text-center">
                                    定向班级
                                </p>
                            </div>
                        ...
                        <div class="custom_detail_item">
                            <div>
                                <img src="Images/custom03.jpg" width="100%" alt="">
                                <p class="text-center">
                                    定向大学
                                </p>
                            </div>
        ...
        <div class="oneClass content_item">
            <div class="content_item_bg">
                <img src="Images/Class01.jpg" width="100%" alt="">
                <div class="title font60">
                ...
                <div class="oneClass_content">
                    <div class="oneClass_item">
                        <img src="Images/Class001.jpg" width="100%" alt="">
                        <div class="item_info">
                    ...
                    <div class="oneClass_item">
                        <img src="Images/Class002.jpg" width="100%" alt="">
                        <div class="item_info">
                    ...
                    <div class="oneClass_item">
                        <img src="Images/Class003.jpg" width="100%" alt="">
                        <div class="item_info">
            ...
            <div class="content_item_bg">
                ...
                <div class="teach_content">
                    <div class="teach_team1">
                        <img src="Images/teach01.jpg" alt="">
                    </div>
                    <div class="teach_team2 ">
                        <div class="teach">
                            <img src="Images/teach02.jpg" alt="">
        ...
        <div class="content_item double_class">
            <div class="content_item_bg">
                ...
                <div class="double_content">
                    <img src="Images/shuangshijiangtang.jpg"  width="100%" alt="">
                </div>
        ...
        <div class="content_item">
            <div class="content_item_bg">
                ...
                <div class="works_content">
                    <img src="Images/works_03.jpg" alt="">
                    <img src="Images/works_03.jpg" alt="">
                    <img src="Images/works_03.jpg" alt="">
                    <img src="Images/works_03.jpg" alt="">
                </div>
