                                ...
                                <ul>
                                            ...
                                            <li>
                                                ...
                                                <select name="siteid">
                                                   ...
                                                   <?php 
                                                          $str="";
                                                          foreach ($siteResult as $key=>$v){
                                                              if($siteid == $v["id"]){
                                                                  $sss = 'selected="selected"';
                                                              }else{
                                                                  $sss ="";
                                                              }
                                                              $str .='<option '.$sss.' value="'.$v["id"].'">站点【'.$v["site"].'】</option>';
                                                          }
                                                          echo $str;
                                                   ?>
                                               </select>
                                            ...
                                            <li>
                                                    ...
                                                    <?php 
                                                            $check1 = $attr == 1?" checked='checked' ":"";
                                                            $check2 = $attr == 2?" checked='checked' ":"";
                                                            $check3 = $attr == 3?" checked='checked' ":"";
                                                    ?>
