                                ...
                                <ul>
                                            <li>
                                                 ...
                                                 <select name="pid">
                                                        ...
                                                        <option  value="1">首页</option><option  value="2">关于我们</option><option  value="7">|--公司简介</option><option  value="8">|--企业文化</option><option  value="9">|--发展前景</option><option  value="10">|--社会责任</option><option  value="3">专栏文章</option><option  value="4">新闻中心</option><option  value="11">|--公司动态</option><option  value="12">|--行业动态</option><option  value="5">产品展示</option><option  value="13">|--放信息泄露产品</option><option  value="14">|--加固产品</option><option  value="15">|--主板产品</option><option  value="16">|--屏蔽材料</option><option  value="17">|--定制机箱</option><option  value="6">联系我们</option><option  value="18">|--联系方式</option><option  value="19">|--招聘信息</option>                                                 </select>
                                            ...
                                            <li>
                                                ...
                                                <select name="siteid">
                                                   ...
                                                   <option selected="selected" value="1">站点【1】</option><option  value="2">站点【2】</option>                                               </select>
                                            </li>
                                            
                                            <li>
                                                 <span class="t001">栏目名称：</span>
                                                 <input name="title" type="text" style="width: 300px;" value="首页" />
                                                 <span class="sm001"><b class="red">*</b></span>
                                            </li>
                                            <li>
                                                    <span class="t001">属　　性：</span>
                                                                                                        <label><input style="width: auto;" type="radio" name="attr"  checked='checked'  class="attr" value="1" /> 【单页】</label>
                                            ...
                                            <li>
                                                 ...
                                                 <input name="url" type="text" style="width: 150px;" value="index.php?mo=1"/>
                                                 <span class="sm001"><b class="red">*</b></span>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                 ...
                                                 <input name="orderid" type="text" style="width: 100px;" value="0"/>
                                                 <span class="sm001"><b class="red">*</b></span>
                                            </li>
        ...
        if (sub_go == 0) {
            ...
            <div class="footer">
                <div class="footer-butt-l"><a href='/yijiyi/index.php?m=YiJiaYicms&c=Index&a=index'></a></div>
                    <span class="footer-title">栏目类型 - 修改</span>
