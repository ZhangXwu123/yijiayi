        ...
        <div class="master">
            <div class="login-page">
                <div class="login-page-c">
                        <h2></h2>
                        <form action="/yijiayi/index.php?m=YiJiaYicms&c=Login&a=prologin" method="post">
                            <div class="condition">
                                <ul>
                                    ...
                                    <li><span>验证码：</span><input type="text"  name="vcode"   style="width:100px;" value="" placeholder="验证码..." /><a  onclick="$('.vcode').attr('src','/yijiayi/index.php?m=YiJiaYicms&c=Login&a=vcode&'+(new Date()).valueOf())"><img title="看不清？请点击" style="height: 37px; cursor: pointer; margin-top: -3px" class="vcode" src="/yijiayi/index.php?m=YiJiaYicms&c=Login&a=vcode"/></a></li>
