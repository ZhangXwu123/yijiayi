    ...
    <!--上操作栏结束-->    <!--主体内容-->
     <div class="index main-content">
        ...
        <div class="nav-button">
            <ul class="clear">
                <a href="" class="menu_item">首页</a><li><a href=""><img src="/yijiyi" alt=""><span>首页</span></a></li>                <li><a href="about.html"><img src="/yijiyi/Public/Home/images/menu_new01.jpg" alt=""><span>关于我们</span></a></li>
