    ...
    <!--上操作栏结束-->    <!--主体内容-->
     <div class="index main-content">
        ...
        <div class="nav-button">
            <ul class="clear">
                <li><a href=""><img src="/yijiyi/Public/upload/YiJiaYi/column/2018/20180201/20180201151040Ty.jpg" alt=""><span>关于我们</span></a></li><li><a href=""><img src="/yijiyi" alt=""><span>榜上有名</span></a></li><li><a href=""><img src="/yijiyi" alt=""><span>培训课程</span></a></li><li><a href=""><img src="/yijiyi" alt=""><span>双师课程.</span></a></li><li><a href=""><img src="/yijiyi" alt=""><span>名校规划</span></a></li>            </ul>
        </div>
        <!-- 固定导航按钮结束-->
        <!-- 相信榜样的力量-->
