...
<html>
    <head>
        ...
        <link href="/yijiyi/Public/Home/css/css.css"  rel="stylesheet" type="text/css" />
        <link href="/yijiyi/Public/Home/tool/laydate/need/laydate.css" rel="stylesheet" type="text/css" />
        <script src="/yijiyi/Public/Home/javascript/jquery-1.12.3.min.js"></script>
        <script src="/yijiyi/Public/Home/javascript/javascript.js"></script>
        <script type="text/javascript" src="/yijiyi/Public/Home/tool/laydate/laydate.js"></script>
    </head>
    <body>
            <div class="header">
                <!--头部-->
                <div class="head-top wrap">
                    <div class="logo-img">
                        <a href="http://localhost/2018.01.13/index.php"><img src="/yijiyi/Public/upload/JCHK/logo/2018/20180115/logo.jpg"/></a>
                    </div>
                    <div class="nav">
                            <ul class="ul-nav">
