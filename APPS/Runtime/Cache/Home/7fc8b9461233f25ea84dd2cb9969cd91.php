...
<div class="bd-container">
    ...
    <header>
        ...
        <a href="http://localhost/2018.01.13/index.php"><img src="/yijiyi/Public/upload/YiJiaYi/logo/2018/20180201/logo.png" class="img-title ele-center"/></a>
    </header>
    <!--上操作栏结束-->    <!--主体内容-->
     <div class="index main-content">
        ...
        <div class="nav-button">
            <ul class="clear">
                <li><a href="about.html"><img src="/yijiyi/Public/Home/images/menu_new01.jpg" alt=""><span>关于我们</span></a></li>
                <li><a href="honor_roll.html"><img src="/yijiyi/Public/Home/images/menu_new02.jpg" alt=""><span>榜上有名</span></a></li>
                <li><a href=""><img src="/yijiyi/Public/Home/images/menu_new03.jpg" alt=""><span>培训课程</span></a></li>
                <li><a href=""><img src="/yijiyi/Public/Home/images/menu_new04.jpg" alt=""><span>双师课程</span></a></li>
                <li><a href=""><img src="/yijiyi/Public/Home/images/menu_new05.jpg" alt=""><span>名校规划</span></a></li>
            </ul>
        </div>
        <!-- 固定导航按钮结束-->
        <!-- 相信榜样的力量-->
